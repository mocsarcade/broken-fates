...
using UnityEngine;
//Import the namespace from RoomManager.cs to use the Direction enum
...
public class RoomSpawner : MonoBehaviour {
	...
	void Spawn() {
        if(spawned == false)
        {
            ...
            else if (openingDir == Direction.Left)
            {
            ...
            else if (openingDir == Direction.Up)
            {
            ...
            else if (openingDir == Direction.Right)
            {
